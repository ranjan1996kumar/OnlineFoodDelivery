<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Resturent.aspx.cs" Inherits="OnlineFoodOder.Explore_Resturent.Resturent" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<title>Explore Restaurant's</title>
	<link href="../Explore%20Resturent/style.css" rel="stylesheet" />
</head>
<body>
	<div class="res-sidebar food_cat_filter">
			<div id="food_filter_widget-2" class="widget res-sidebar-box"></div>
				<div class="heading-panel-simple">
					<div class="my-heading-style">
						<h3>Filters</h3>
					</div>
					<div class="res-sidebar-style" id="reloader-fun">
						<span><i class="fa fa-refresh"></i>Refresh</span>

					</div><div class="bottom-dots  clearfix">
			...
			<ul>
				<li>
					<div class="pretty p-switch p-fill" id="check-delivery">
						<input type="radio" id="delivery" name="checkmate" value="delivery">
						<div class="state">
							<label></label>
				...
				<li>
					<div class="pretty p-switch p-fill" id="check-pickup">
						<input type="radio" id="pickup" name="checkmate" value="pickup">
						<div class="state">
							<label></label>
	...
	<div id="food_categories_filter_widget-2" class="widget res-sidebar-box">
		<div class="heading-panel-simple">
			<div class="my-heading-style">
  ...
  <%--  ...........................................--%>
	  <div class="single-pro">
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/1.jpg"  alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/1.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">

							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick Views</a>
								</div>
							</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Saffron - Radisson Blu Bengaluru</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/10.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/10.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Chowman (Marathahalli)</a></h4>
							<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
								<form action="#" method="post">
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/11.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/11.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Konark Restaurant</a></h4>
							<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
								<form action="#" method="post">
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/12.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/12.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">The Creek</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/2.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/2.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Yauatcha Bengaluru</a></h4>
							<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
								<form action="#" method="post">
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/3.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/3.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">The Black Pearl Marathahalli</a></h4>
							<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
								<form action="#" method="post">
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/4.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/4.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Pepper Leaf Restaurant</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/5.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/5.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Oota Bangalore</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/6.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/6.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;"
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Melange - Radisson Blu Bengaluru</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/7.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/7.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Absolute Barbecues - Bangalore </a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="Images/8.jpg" alt="" class="pro-image-front" style="width:1100px; height:800px;">
							<img src="Images/8.jpg" alt="" class="pro-image-back" style="width:1100px; height:800px;">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Erivum Puliyum</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Otto's Marathahalli</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Shiro</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						...
						<div class="item-info-product ">
							<h4><a href="single.html">The Fisherman's Wharf</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Edo Restaurant & Bar - ITC Gardenia</a></h4>
				...
				<div class="col-md-3 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						...
						<div class="item-info-product ">
							<h4><a href="single.html">Karavalli - The Gateway Hotel</a></h4>
